...
def print_overall_metric(F_seg_a, F_seg_v, F_seg, F_seg_av, F_event_a, F_event_v, F_event, F_event_av):
    ...
    exp_logger("\n")    
    exp_logger('Segment-level@Audio \t {:.1f}'.format(audio_segment_level))
    exp_logger('Segment-level@Video \t {:.1f}'.format(visual_segment_level))
    exp_logger('Segment-level@Aud-Vis \t {:.1f}'.format(av_segment_level))
    exp_logger('Segment-level@Type \t {:.1f}'.format(avg_type_seg))
    exp_logger('Segment-level@Event \t {:.1f}'.format(avg_event_seg))
    exp_logger('Event-level@Audio \t {:.1f}'.format(audio_event_level))
    exp_logger('Event-level@Video \t {:.1f}'.format(visual_event_level))
    exp_logger('Event-level@Aud-Vis \t {:.1f}'.format(av_event_level))
    exp_logger('Event-level@Type \t {:.1f}'.format(avg_type_eve))
    exp_logger('Event-level@Event \t {:.1f}'.format(avg_event_eve))
